...
class DocumentsRecentListController(QObject): 
    ...
    def _connect_signals(self):
        ...
        logger.info("DocumentsRecentListController signals connected.") # Remplacé print
    ...
    def load_recent_documents(self):
        ...
        logger.info("RecentListController: Loading recent documents...") # Remplacé print
    ...
    def _handle_new_request(self):
        ...
        logger.info("RecentListController: New document requested.") # Remplacé print
    ...
    def _handle_open_request(self):
        ...
        logger.info("RecentListController: Open document dialog requested.") # Remplacé print
    ...
    def _handle_open_specific_request(self, path):
        ...
        logger.info(f"RecentListController: Open specific document requested: {path}") # Remplacé print
    ...
    def _handle_remove_request(self, path):
        ...
        logger.info(f"RecentListController: Remove recent requested: {path}") # Remplacé print
...
# logger.info("DocumentsRecentListController defined") # Remplacé print et commenté 